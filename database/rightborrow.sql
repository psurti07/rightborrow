...
(5, 'welcome-message', '<h1 dir=\"ltr\">&nbsp;</h1>\r\n\r\n<h4 dir=\"ltr\" style=\"text-align:center\"><span style=\"font-size:16px\"><strong>Happy Ganesh Visarjan</strong></span></h4>\r\n\r\n<h4 dir=\"ltr\" style=\"text-align:center\"><br />\r\n<span style=\"font-size:14px\">Hello, Our Office will Remain closed on 06/09/2025 due to Ganesh Visarjan&nbsp;Thanks, easyrightborrow</span></h4>', '2024-02-23 06:00:52', 2),
(6, 'account-message', '<p style=\"text-align:center\"><strong>Happy Holi</strong><strong> </strong><br />\r\nHello, our Office will remain closed on 14/03/2025 due to Holi Thanks,easyrightborrow</p>', '2024-02-23 06:50:30', 1),
...
(10, '2026-03-26 15:41:50', 'Pleasure Serving You!', '<p>Dear Customer, We hope our services guided you well. If you\'ve any queries, kindly call on 9983933307 Monday-Saturday between 10 am - 5 pm on business days. Thanks, easyrightborrow</p>', 10, 0),
(11, '2026-03-26 15:42:35', 'Looking forward to serving you!', '<p>Dear Customer, it would have been great if you would have given us the opportunity to serve you. Nevertheless, we really hope you will avail our services in future. If you\'ve any queries, kindly call on 9983933307Monday-Saturday between 10 am - 5 pm on business days. Thanks, easyrightborrow</p>', 10, 0),
(12, '2025-07-18 15:09:04', 'Successful Customer Verification', '<p>Dear Customer,\nIt was great speaking with you!\n\nWe’re glad to inform you that you’ve successfully inched closer towards making the most of our services!\n\nWe really wish our services help you abundantly!\n\nThanks,\neasyrightborrow</p>', 6, 0),
...
(1, '2026-04-04 14:32:06', 1, 'get_offer', 'Get Offer', 'You\'re eligible for a pre-approved loan of Rs.{#varamount#}. Get funds in just 30 minutes. Limited-time offer. Apply now: https://kbzp.in/EASYAI/hxjaq Easyrightborrow', 1),
(2, '2026-04-04 12:38:30', 1, 'remarketing_sms', 'Remarketing SMS', 'You\'re eligible for a pre-approved loan of Rs.{#varamount#}. Get funds in just 30 minutes. Limited-time offer. Apply now: https://kbzp.in/EASYAI/hxjaq Easyrightborrow', 1),
(3, '2026-04-08 14:18:39', 1, 'payment_unsuccessful', 'Payment Unsuccessful', 'Sorry, your payment for Easyrightborrow Subscription was not successful. Try Another Payment Method here https://kbzp.in/EASYAI/cswck Easyrightborrow', 1),
(4, '2026-04-04 11:22:41', 1, 'payment_successful', 'Payment Successful', 'Dear Customer, Your Payment for Self-Apply has been successful! Check your reg. email and login to customer portal to proceed ahead. Thanks, Easyrightborrow', 1),
(6, '2026-04-04 14:32:39', 2, 'get_offer', 'Get Offer', 'You\'re eligible for a pre-approved loan of Rs.{#varamount#}. Get funds in just 30 minutes. Limited-time offer. Apply now: https://kbzp.in/EASYAI/hxjaq Easyrightborrow', 1),
(5, '2026-04-18 15:59:58', 1, 'forgot_password', 'Forgot Password', 'Hello{#varamount#} Your Easyrightborrow account\'s new password is {#varamount#}. Do not share it with anyone. Thanks, Easyrightborrow', 1),
(7, '2026-04-04 14:26:33', 2, 'remarketing_sms', 'Remarketing SMS', 'Congrats! Your Rs.{#varamount#} pre-approved loan is processed. Get money in your bank A/C within 30 mins. Apply now: https://kbzp.in/EASYAI/waacr Easyrightborrow', 1),
(8, '2026-04-08 14:17:55', 2, 'payment_unsuccessful', 'Payment Unsuccessful', 'Sorry, your payment for Easyrightborrow Subscription was not successful. Try Another Payment Method here https://kbzp.in/EASYAI/fzyhi Easyrightborrow', 1),
(9, '2026-04-04 11:21:33', 2, 'payment_successful', 'Payment Successful', 'Dear Customer, Your Payment for Hire Agent has been successful! Check your reg. email and login to customer portal to proceed ahead. Thanks, Easyrightborrow', 1),
(10, '2026-04-18 15:56:48', 2, 'forgot_password', 'Forgot Password', 'Hello{#varamount#} Your Easyrightborrow account\'s new password is {#varamount#}. Do not share it with anyone. Thanks, Easyrightborrow', 1),
(11, '2026-04-07 15:35:03', 3, 'ticket_raised', 'Support Request  – Ticket Raised', 'Your request ticket has been raised in our system with the Ticket Id: {#varamount#}. We will contact you within 24-48 hours for a follow-up. Easyrightborrow', 1),
(12, '2026-04-07 15:35:17', 3, 'ticket_underprocess', 'Support Request – Under Process', 'Hello, Your request with Ticket ID: {#varamount#} is under process. The query will be solved soon and it will be informed to you shortly. Thanks, Easyrightborrow', 1),
(13, '2026-04-07 15:35:46', 3, 'ticket_noresponse', 'Support Request – No-response Closed', 'Hello, Your request with Ticket Id: {#varamount#} is closed as the company tried calling you for the last 3 days but got no response. Thanks, Easyrightborrow', 1),
(14, '2026-04-07 15:36:12', 3, 'ticket_solved', 'Support Request – Solved', 'Hello, Your request with Ticket Id: {#varamount#} is Solved. We thank you for the opportunity to serve you. Thanks, Easyrightborrow', 1),
(15, '2026-04-07 15:34:48', 3, 'ticket_closed', 'Support Request – Closed', 'Hello, Your request with Ticket Id: {#varamount#} is closed as the company tried calling you for the last 3 days but got no response. Thanks, Easyrightborrow', 1),
(16, '2026-03-31 16:44:52', 1, 'sales_cycle_days', 'After Sales Cycle - 1,2,3,5 days', 'Dear Customer, We Hope You\'ve Utilised Loan Self Login links. If not, click https://kbzp.in/EASYAI/owpzx and check Pre-Approved Loan section. Thanks! Easyrightborrow', 1),
(17, '2026-03-25 13:37:58', 1, 'sales_cycle_closed', 'After Sales Cycle - Closed', 'Dear Customer, We hope our services guided you well. If you\'ve any queries, kindly call on 9983933307 Mon-Sat 10am-5pm on business days. Thanks, Easyrightborrow', 1),
(18, '2026-03-25 12:36:27', 2, 'sales_cycle_closed', 'After Sales Cycle - Closed', 'Dear Customer, We hope our services guided you well. If you\'ve any queries, kindly call on 9983933307 Mon-Sat 10am-5pm on business days. Thanks, Easyrightborrow', 1),
(19, '2026-04-07 17:19:36', 2, 'app_remarks_add', 'Application Remarks Add', 'Dear Customer, the latest update of your loan file is displayed on your customer portal & sent to your email id. Check here https://kbzp.in/EASYAI/owpzx Easyrightborrow', 1),
(20, '2026-04-04 12:58:01', 1, 'verified_customer', 'Verified Customer', 'Dear Customer, We hope you will make the most of the guidance provided by our Company Executive. For any further assistance, please call on 9983933307from Monday-Saturday between (10:00 AM to 5:00 PM) only business days. Thanks, Easyrightborrow', 1),
(21, '2026-04-07 15:37:32', 4, 'get_offer_', 'Get Offer', 'Congrats! Your Rs.{#varamount#}/- Pre-Approved Loan Processed Successfully. Get Money in Your Bank A/C 30 minutes. Apply Now {#varamount#} Easyrightborrow', 1),
(23, '2026-04-07 15:36:51', 4, 'get_offer', 'Get Offer', 'Congrats! Your Rs.{#varamount#}/- Pre-Approved Loan Processed Successfully. Get Money in Your Bank A/C 30 minutes. Apply Now {#varamount#} Easyrightborrow', 1),
(24, '2026-03-24 14:07:29', 4, 'payment_unsuccessful', 'Payment Unsucessful', 'Sorry, your payment for Easyrightborrow Subscription was not successful. Try Another Payment Method here {#var#} Easyrightborrow', 1),
(25, '2026-03-23 16:20:55', 4, 'payment_successful', 'Payment Successful', 'Dear Customer, Your Payment for Loan Assistant Plan has been successful! Check your reg. email and login to customer portal to proceed ahead. Thanks,Easyrightborrow', 1),
(26, '2026-04-07 16:54:37', 4, 'forgot_password', 'Forget Password', '#', 1),
(27, '2026-03-23 16:20:22', 4, 'pre_approved', 'Pre Approved', '#', 1),
(28, '2026-04-07 15:38:00', 4, 'remarketing_sms', 'Remarketing SMS', 'You\'re Eligible For Rs.{#varamount#}/- Pre-Approved Loan Offer. Disbursement in Just 30 minutes. Limited Time Offer Only. Apply Now {#varamount#} Easyrightborrow', 1),
(29, '2026-03-23 15:59:13', 4, 'sales_cycle_closed', 'After Sales Cycle - Closed', '#', 1),
(30, '2026-03-31 15:59:53', 2, 'sales_cycle_days', 'After Sales Cycle - 1,2,3,5 days', 'Dear Customer, We Hope You\'ve Utilised Loan Self Login links. If not, click https://kbzp.in/EASYAI/owpzx and check Pre-Approved Loan section. Thanks! Easyrightborrow', 1),
