            ...
            <div class="col-lg-6 col-md-12 col-12 align-items-center m-auto self-apply-form mb-lg-0 mb-3">
               ...
               <div class="col-lg-6 col-md-12 col-12 m-auto">
                <div class="hero-7-img bg--green-100 rounded-3 mt-0 text-center">
                    <img src="{{ asset('front/images/self-apply-img.png') }}" alt="rightborrow" class="img-fluid p-0">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12 col-lg-12 col-xl-12">
                <div class="form-holder">
                    <div class="contact-form-notice">
                        <p class="s-14">
                            <strong>Important Disclosure : </strong> Rightborrow Private Limited is a service provider that connects users with third-party banks and NBFCs and does not provide loans directly. The repayment tenure for personal loans typically ranges from a minimum of 6 months to a maximum of 60 months (5 years), depending on the lender. The maximum Annual Percentage Rate (APR) can go up to 34.5% per annum, inclusive of applicable charges, depending on the applicant’s profile and lender policies.
                        </p>
