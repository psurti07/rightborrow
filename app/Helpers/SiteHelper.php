    ...
    function nbfcsList()
    {
        ...
        foreach ($banks as $bank) {
            $data['list'] .= '<div class="col company" data-index="' . $loop . '">
                            <a href="javascript:;" class="in_tool it-1 r-10">
                                <div class="bg--white-100 block-shadow r-10 mb-20">
                                    <img class="img-fluid" src="https://manage.rightborrow.com/public/upload/banks/' . $bank->bank_image . '" alt="' . $bank->bank_name . '" width="200">
                                </div>
            ...
            $data['carousel'] .= '<div class="bg--white-100 r-10 mb-0 p-2 border">
                                    <a href="javascript:;">
                                        <img class="img-fluid" src="https://manage.rightborrow.com/public/upload/banks/' . $bank->bank_image . '" alt="' . $bank->bank_name . '" width="auto">
                                    </a>
                                </div>';
            $loop++;
        }
            ...
            <ul class="accordion">
                <li class="accordion-item mb-0">
                    <div class="accordion-thumb">
                        <h6 class="s-16 w-500 mb-0">I paid, but the account is still not set up. What do I need to do? </h6>
                    </div>
                    <div class="accordion-panel">
                        <div class="accordion-panel-item">
                            <div class="faqs-2-answer">
                                <p>
                               This could happen if the payment gateway is holding your money and it has not yet been credited to the company account. Do not worry; you well get an email when the money is in the company account and your account is set up. Otherwise, the payment gateway will refund your funds according to their policies. </p>
                            </div>
                        </div>
                    </div>
                </li>
                <li class="accordion-item mb-0">
                    <div class="accordion-thumb">
                        <h6 class="s-16 w-500 mb-0">I have yet to receive my refund, even after so many days. What shall I do? </h6>
                    </div>
                    <div class="accordion-panel">
                        <div class="accordion-panel-item">
                            <div class="faqs-2-answer">
                                <p>
                                    This could happen if your money is being held by a bank/payment gateway. It will be refunded in accordance with the bank/payment gateway rules and regulations. 
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <li class="accordion-item mb-0">
                    <div class="accordion-thumb">
                        <h6 class="s-16 w-500 mb-0">I misunderstood the company service and/or made a mistake in payment. Can I get a refund? </h6>
                    </div>
                    <div class="accordion-panel">
                        <div class="accordion-panel-item">
                            <div class="faqs-2-answer">
                ...
                <li class="accordion-item mb-0">
                    <div class="accordion-thumb">
                        <h6 class="s-16 w-500 mb-0">I received pre-approved loan offers based on my eligibility, but I did not receive a loan. Why?</h6>
                    </div>
                    <div class="accordion-panel">
                        <div class="accordion-panel-item">
                            <div class="faqs-2-answer">
                                <p>
                                   To fully understand what a pre-approval loan offer is, please read the terms and conditions.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <li class="accordion-item mb-0">
                    ...
                    <div class="accordion-panel">
                        <div class="accordion-panel-item">
                            <div class="faqs-2-answer">
                                <p>
                                    Anyone who has updated their GST information through the portal will receive a GST return.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <li class="accordion-item mb-0">
                    <div class="accordion-thumb">
                        <h6 class="s-16 w-500 mb-0">I changed my mind and no longer want to use the company services. Can I request a refund? </h6>
                    </div>
                    <div class="accordion-panel">
                        <div class="accordion-panel-item">
                            <div class="faqs-2-answer">
                ...
                <li class="accordion-item mb-0">
                    <div class="accordion-thumb">
                        <h6 class="s-16 w-500 mb-0">I am not pleased with the company service. What am I supposed to do?</h6>
                    </div>
                    <div class="accordion-panel">
                        <div class="accordion-panel-item">
                            <div class="faqs-2-answer">
                ...
                <li class="accordion-item mb-0">
                    ...
                    <div class="accordion-panel">
                        <div class="accordion-panel-item">
                            <div class="faqs-2-answer">
                                <p>
                                    Customers who make multiple payments are eligible for refunds. You can request a refund within 48 hours of making the payment by visiting the website Raising A Request section or calling the company registered phone number.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <li class="accordion-item mb-0">
                    ...
                    <div class="accordion-panel">
                        <div class="accordion-panel-item">
                            <div class="faqs-2-answer">
                                <p>
                                   If a customer purchased Subscriptions/Memberships from more than one company in our group, they are eligible for a refund. You can request a refund within 48 hours of payment by visiting the website Raising A Request section or calling the company registered phone number.
                                </p>
                            </div>
                        </div>
                    </div>
